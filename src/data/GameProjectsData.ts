...
export default [
  new ProjectData(
    "project-1",
    "Flappy Bird (Phaser3)",
    "img/projects/flappy-bird.png",
    `https://birdman1104.github.io/flappy-bird/`,
    "#23bd69",
    true
  ),
  new ProjectData(
    "project-2",
    "Playrix Playable Ad Test Task (PixiJS)",
    "img/projects/playrix.png",
    `https://birdman1104.github.io/playrix-test-task/`,
    "#F4511E"
  ),
  new ProjectData(
    "project-3",
